    ...
    <main className="flex min-h-screen flex-row items-start p-10 gap-10">
      <div className="flex flex-1 flex-col items-start gap-10">
        <div className="w-full flex flex-col gap-6 lg:h-[calc(40vh)] items-center justify-center">
          ...
          <p className="font-normal text-lg lg:text-2xl text-center lg:max-w-[75%]">
        ...
        <div className="flex gap-10 flex-wrap justify-center">
          {work.map(
            ({ title, description, image, url, stack, position, slug }) => (
              <div
                key={url}
                className="flex flex-col gap-4 bg-background border-b-2 border-slate-200 py-6 w-full lg:h-[calc(40vh)] items-start lg:w-[45%] justify-between"
              >
                <div className="flex flex-col gap-3">
                  ...
                  {/* <p className="font-semibold text-md lg:text-lg mb-10">
                  Joined {joined}
                </p> */}
